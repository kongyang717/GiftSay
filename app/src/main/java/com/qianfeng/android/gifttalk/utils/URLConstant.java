...
public class URLConstant {
     ...
     * 指南界面头部banner列表
     */
    public static final String GUIDE_HOME_HEAD_BANNER = "http://api.liwushuo.com/v2/banners";
    /**
     * 指南界面内容列表
     */
     ...
     * 指南详情界面
     */
    public static final String GUIDE_DETAILS_CONTENTS="http://api.liwushuo.com/v2/posts_v2/1044408?show_baichuan=1";
}
